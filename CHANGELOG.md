...
*   **Sprachwahl-Design:** Umstellung der Sprachnavigation auf Badge-Buttons (Flagge + Name). Aktive Sprache in kontrastreichem **Petrol/Dunkelcyan** (`00838F`) hervorgehoben für optimale Lesbarkeit.
